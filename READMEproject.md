...
## Description:
The task was to create a command-lin application that dynamcailly generates a professional README.md file from a user's input using the inquirer package.
